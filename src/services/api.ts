...
export const productsAPI = {
  ...
  create: (product: Omit<Product, "id">, imageFile?: File) => {
    if (imageFile) {
  ...
  update: (id: number, product: Partial<Product>, imageFile?: File) => {
    if (imageFile) {
      const formData = new FormData();
      formData.append("image", imageFile);
      formData.append("type", "products");
...
export const newsAPI = {
  ...
  create: (news: Omit<News, "id">, imageFile?: File) => {
    if (imageFile) {
      const formData = new FormData();
      formData.append("image", imageFile);
  ...
  update: (id: number, news: Partial<News>, imageFile?: File) => {
    if (imageFile) {
      const formData = new FormData();
      formData.append("image", imageFile);
      formData.append("type", "news");
...
export const bannersAPI = {
  ...
  create: (banner: Omit<HeroBanner, "id">, imageFile?: File) => {
    if (imageFile) {
      const formData = new FormData();
      formData.append("image", imageFile);
      ...
      return apiCall<HeroBanner>("/banners", {
        method: "POST",
        body: formData,
        headers: {}, // Remove Content-Type to let browser set it
      });
  ...
  update: (id: number, banner: Partial<HeroBanner>, imageFile?: File) => {
    if (imageFile) {
      const formData = new FormData();
      formData.append("image", imageFile);
      formData.append("type", "home");
      ...
      return apiCall<HeroBanner>(`/banners/${id}`, {
        method: "PUT",
        body: formData,
        headers: {}, // Remove Content-Type to let browser set it
      });
